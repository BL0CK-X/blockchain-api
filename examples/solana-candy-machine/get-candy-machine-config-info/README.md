### Example for the <a href="https://docs.theblockchainapi.com/#tag/Solana-Candy-Machine/paths/~1v1~1solana~1nft~1candy_machine~1config~1info/post">"Get the candy machine configuration settings" endpoint</a>.
