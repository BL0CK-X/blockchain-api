### Example for the <a href="https://docs.theblockchainapi.com/#tag/Solana-NFT/paths/~1v1~1solana~1nft~1candy_machine/post">"Create a test candy machine" endpoint</a>.
