...
def example():
    ...
    def get_is_candy_machine(pub_key, title, network):
        response = BLOCKCHAIN_API_RESOURCE.get_is_candy_machine(
            public_key=pub_key,
            network=network
        )
        print(title)
    ...
    # Get an NFT
    get_is_candy_machine("EEr5yQpNXf7Bru6Rt5podx56HGW9CEehXqgRGh2wa71w", "NFT Account", SolanaNetwork.MAINNET_BETA)

    # Get an SPL Token
    get_is_candy_machine("SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt", "SPL Token", SolanaNetwork.MAINNET_BETA)

    # Get smart contract
    get_is_candy_machine("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA", "Smart Contract", SolanaNetwork.MAINNET_BETA)
