...
console.log("We haven't listed the NFT yet, so there should be no listing and `listingDetails` should be null.")
...
listingDetails = await marketplaceApi.solanaGetNFTListing(network, mintAddress).then((data) => {
  return data;
}, (error) => {
  console.error(error);
  return null;
