...
def example():
    ...
    nft_owner = BLOCKCHAIN_API_RESOURCE.get_nft_owner(mint_address, network)
    print(f"The second wallet now owns the NFT because it was purchased with this wallet: {nft_owner}")
